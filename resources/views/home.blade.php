...
@section("content")
    ...
    <!-- End Lotifications -->
    <section id="lotifications" class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="grid gap-5 row-gap-10 lg:grid-cols-4">
                @foreach ($lotifications as $lotification)
                    <div href="#" class="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">{{ $lotification->nombre }}</h5>
                        <p class="font-normal text-gray-700">Ubicación: {{ $lotification->departamento }}, {{ $lotification->ciudad }}</p>
                        <p class="font-normal text-gray-700">Precio: L. {{ number_format($lotification->precio,2) }}</p>
                    </div>
                @endforeach
            </div>
        {{ $lotifications->links('pagination::tailwind') }}
        </div>
    </section>
    <!-- End Lotifications -->
